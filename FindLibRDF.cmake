...
pkg_check_modules(librdf_PKGCONF redland)
message(STATUS "librdf_PKGCONF_FOUND = ${librdf_PKGCONF_FOUND}")
message(STATUS "librdf_PKGCONF_INCLUDE_DIRS = **${librdf_PKGCONF_INCLUDE_DIRS}**")
...
find_library(librdf_LIBRARY
  NAMES rdf
  PATHS ${librdf_PKGCONF_LIBRARY_DIRS}
)
